...
#        ret_list.append(tuple(create_close_conn_obj(sock_fd)))
        ...
        # TODO: Check if the pid exists in the map
        # remove the sock_fd from the list
        # if list size is 0 remove the entry from dict and
        # create close_conn_obj(sock_fd, pid)
